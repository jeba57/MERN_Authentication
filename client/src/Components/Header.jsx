...
const Header = () => {
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
      ...
      font-medium mb-2'>Hey Developers
    ...
    <p className='mb-8 max-w-md'>
        Lets start with a quick product 
        toure and we will have you up and 
        running in no time !</p>
        <button className=' border border-geay-500 rounded-full px-8 py-2.5
